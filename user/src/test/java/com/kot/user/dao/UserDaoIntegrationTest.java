...
public class UserDaoIntegrationTest {
	...
	void testFindByFirstNameEqual() {
		...
		FilteringCriteria criteria = new FilteringCriteria("firstName", FilteringOperation.EQUAL, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
	...
	void testFindByFirstNameContain() {
		...
		FilteringCriteria criteria = new FilteringCriteria("firstName", FilteringOperation.CONTAIN, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
	...
	void testFindByLastNameEqual() {
		...
		FilteringCriteria criteria = new FilteringCriteria("lastName", FilteringOperation.EQUAL, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
	...
	void testFindByLastNameContain() {
		...
		FilteringCriteria criteria = new FilteringCriteria("lastName", FilteringOperation.CONTAIN, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
	...
	void testFindByFullNameEqual() {
		...
		FilteringCriteria criteria = new FilteringCriteria("fullName", FilteringOperation.EQUAL, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
	...
	void testFindByFullNameContain() {
		...
		FilteringCriteria criteria = new FilteringCriteria("fullName", FilteringOperation.CONTAIN, "someOne");
		Specification<UserEntity> specification = new UserSpecificationsBuilder().buildSpecification(criteria);
