...
public class DishV1Controller {
    ...
    public List<LabelV1Response> getLabels() {
        List<LabelEntity> labelEntities = labelService.getAll();
        return labelEntities.stream().map(LabelV1Response::new).toList();
    }
