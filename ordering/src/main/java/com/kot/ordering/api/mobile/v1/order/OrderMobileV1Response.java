...
public class OrderMobileV1Response {
    ...
    private UserDetailV1MobileResponse userDetail;

    private DeliveryAddressV1MobileResponse deliveryAddress;
    ...
    public UserDetailV1MobileResponse getUserDetail() {
        return userDetail;
    }

    public void setUserDetail(UserDetailV1MobileResponse userDetail) {
        this.userDetail = userDetail;
    }

    public DeliveryAddressV1MobileResponse getDeliveryAddress() {
        return deliveryAddress;
    }

    public void setDeliveryAddress(DeliveryAddressV1MobileResponse deliveryAddress) {
